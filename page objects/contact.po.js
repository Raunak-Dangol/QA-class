...
async add(firstName, lastName, dateOfBirth, email, phone, address, city, state, postal, country) {
...
await expect(fNameValidation).toHaveText(fName);
  ...
  async viewLastContact() {
    await this.page.locator('//tbody/tr[last()]/td[1]').click();
  }
